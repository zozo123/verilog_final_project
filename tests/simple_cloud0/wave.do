...
add wave -noupdate -group dut -format Logic /sim_project/ref_dut/a
add wave -noupdate -group dut -format Logic /sim_project/ref_dut/b
add wave -noupdate -group dut -format Logic /sim_project/ref_dut/c
add wave -noupdate -group dut -format Logic /sim_project/ref_dut/d
add wave -noupdate -group dut -format Logic /sim_project/ref_dut/e
add wave -noupdate -group dut -format Logic /sim_project/ref_dut/n1
add wave -noupdate -group dut -format Logic /sim_project/ref_dut/f
add wave -noupdate -group dut -format Logic /sim_project/ref_dut/g
add wave -noupdate -group dut -format Logic /sim_project/ref_dut/o1
add wave -noupdate -group dut -format Logic /sim_project/ref_dut/o2
...
WaveRestoreCursors {{Cursor 2} {9609844 ps} 0} {{Cursor 2} {14131000 ps} 0}
